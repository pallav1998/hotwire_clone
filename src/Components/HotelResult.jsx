...
export function HotelResult() {
    ...
    const ratinghotel=Math.floor(Math.random()*2+3)
    ...
    return (
        <div>
         ...
         <Grid container>
          <Grid item className={styles.gridContanier1}>
            <div>
            ...
            <div>
            <div style={{maxHeight:!show?"200px":"100%",overflow:"hidden"}}>
            ...
            <Button variant="contained" color="secondary" onClick={()=>setShow(!show)}>Show {!show?"more":"fewer"}</Button>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <div>
                  ...
                  <span>Based on 1,001 - 1,500 reviws</span>
                  </p>
                </div>
              </div>
              <div>
                <p>Ratings summary</p>
                <p> <span>Condition of hotel</span> <span></span> <span>4.0</span> </p>
                <p> <span>Quality of service </span> <span></span> <span>4.2</span> </p>
                <p> <span>Room comfort</span> <span></span> <span>4.0</span> </p>
                <p> <span>Room cleanliness </span> <span></span> <span>4.0</span> </p>
