...
if(booked){
  return <div style={{marginTop:"100px",textAlign:"center",marginBottom:"100px"}}>
    ...
    <h1>Your Stay is from {checkInDetails.checkIn.length===0?today:checkInDetails.checkIn} to {checkInDetails.checkOut.length===0?threedaysAfter:checkInDetails.checkOut} </h1>
  </div>
}
